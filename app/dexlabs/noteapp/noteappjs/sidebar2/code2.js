...
window.handleHTMLSubmit = function () {
...
window.handleLatex = () => {
  if (!noteTextarea) return;
  try {
    noteTextarea.value = window.__latexToUnicode(noteTextarea.value || "");
    updateNoteMetadata();
...
window.__latexToUnicode = function (input) {
  // ---------- Symbol tables ----------
  const GREEK = {
